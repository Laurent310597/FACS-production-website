      ...
      <div className="mx-auto grid max-w-[1500px] gap-6 px-5 py-6 lg:grid-cols-[250px_minmax(0,1fr)] lg:px-8 lg:py-8">
        <aside className="h-fit rounded-[26px] border border-white/10 bg-white/[0.035] p-3 lg:sticky lg:top-28">
          <nav className="grid gap-2 sm:grid-cols-2 lg:grid-cols-1">
            ...
            <NavLink to="/admin/email" end className={navClass}>
              <Mail size={18} /> Email Insights
            </NavLink>
            ...
            <NavLink to="/admin/legal-dashboard" end className={navClass}>
              <BarChart3 size={18} /> Dashboard vận hành
            </NavLink>
            ...
            <div className="mt-2 border-t border-white/10 px-4 pb-1 pt-5 text-[11px] font-bold uppercase tracking-[0.18em] text-slate-600 sm:col-span-2 lg:col-span-1">Finance</div>
            <NavLink to="/admin/ar" end className={navClass}>
              <ReceiptText size={18} /> AR Management
            </NavLink>
