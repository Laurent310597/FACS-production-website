      ...
      <div className="container relative z-10 mx-auto px-6 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-[1.25fr_1fr_1fr_1fr_1.35fr]">
          ...
          <div>
            ...
            <div className="space-y-3 text-slate-400">
              {[["/about", isVi ? "Giới thiệu" : "About"], ["/services", isVi ? "Dịch vụ" : "Services"], ["/industries", isVi ? "Lĩnh vực" : "Industries"], ["/insights", isVi ? "Góc nhìn" : "Insights"], ["/legal-calendar", isVi ? "Lịch pháp lý" : "Legal Calendar"], ["/careers", isVi ? "Tuyển dụng" : "Careers"], ["/contact", isVi ? "Liên hệ" : "Contact"]].map(([to, label]) => (
