...
- The full cinematic sequence runs for about 4.2 seconds, appears once per browser session and can be skipped immediately.
...
- Respects `prefers-reduced-motion` with a readable 2.8-second static treatment instead of the former 320 ms exit.
